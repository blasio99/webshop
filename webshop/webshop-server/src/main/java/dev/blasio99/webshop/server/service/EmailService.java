...
public class EmailService implements Observer{
	...
	@Override
	public void update(OrderLine orderLine, ArrayList<Product> products, Double totalPrice, String email){
		...
		message.setBcc(environment.getUsername());
		message.setTo(email);
	...
	private String mailBodyFormatter(OrderLine orderLine, ArrayList<Product> products, Double totalPrice){
		...
		for(Product product : products)
			stringBuilder.append((++counterForMail) + ". product on the line:" + "\n" + product.toString() + "\n\n");
		
		stringBuilder.append("__________________________________\n");
		stringBuilder.append("\n");
		stringBuilder.append("Total price: \t" + totalPrice + " RON\n");
		stringBuilder.append("__________________________________\n\n");
